 ...
 * Class: This is the class that implements the methods of CustomerDataOverHttps
 */

public class CustomerHttps implements CustomerDataOverHttps {

	@Override
	public String getCustomerWithHTTPSConnect(Customer c) {
		return "HTTPS connection with customer id =>" + c.getId();

	}

	@Override
	public String printHttpsCustomer(Customer c) {
		return("HTTPS! customer's name is:" + c.getName() + " with id: " + c.getId());
